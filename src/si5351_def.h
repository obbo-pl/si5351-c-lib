...
enum {
    SI5351_CLK3_TO_0_DISABLE_STATE_CLK0_bp          = 0,
    SI5351_CLK3_TO_0_DISABLE_STATE_CLK1_bp          = 2,
    SI5351_CLK3_TO_0_DISABLE_STATE_CLK2_bp          = 4,
    SI5351_CLK3_TO_0_DISABLE_STATE_CLK3_bp          = 6,
};
#define SI5351_CLK7_TO_4_DISABLE_STATE              25
enum {
    SI5351_CLK7_TO_4_DISABLE_STATE_CLK4_bp          = 0,
    SI5351_CLK7_TO_4_DISABLE_STATE_CLK5_bp          = 2,
    SI5351_CLK7_TO_4_DISABLE_STATE_CLK6_bp          = 4,
    SI5351_CLK7_TO_4_DISABLE_STATE_CLK7_bp          = 6,
};
enum {
    SI5351_CLK7_TO_0_DISABLE_STATE_CLK_LOW_bm       = 0x00,
    SI5351_CLK7_TO_0_DISABLE_STATE_CLK_HIGH_bm      = 0x01,
    SI5351_CLK7_TO_0_DISABLE_STATE_CLK_HIGHIMP_bm   = 0x02,
    SI5351_CLK7_TO_0_DISABLE_STATE_CLK_NEVER_bm     = 0x03,
};
